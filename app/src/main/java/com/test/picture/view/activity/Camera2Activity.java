...
import com.test.picture.helper.Camera2ActivityHelper;
...
public class Camera2Activity extends BaseActivity {
    ...
    private Camera2ActivityHelper cameraActivityHelper;
    ...
    protected void initView() {
        ...
        cameraActivityHelper = new Camera2ActivityHelper(this, textureView);
        initBrightness();
    }
