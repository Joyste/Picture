...
public class SharedPreferencesUtil {
    ...
    public static String IS_REMOVE_AD_SUCCESS = "isRemoveAdSuccess";
    public static String GOLD_NUM = "goldNum";
    public static String IS_ACCEPT_PRIVACY_POLICY = "isAcceptPrivacyPolicy";
