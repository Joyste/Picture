package lifeexperience.tool.beautycamera.tool;
...
public class PhotoTool {
    ...
    public void startPuzzleWithPhotos(Activity activity, ArrayList<Photo> photos, int REQUEST_CODE) {
        EasyPhotos.startPuzzleWithPhotos(activity, photos, FileUtils.createFolders().getPath(), "puzzle_", REQUEST_CODE, false, GlideEngine.getInstance());
    }
     ...
     * @param REQUEST_CODE
     */
    public void openAlbumForSingle(Activity activity, int REQUEST_CODE,ArrayList<Photo> photos) {
     ...
     * @param REQUEST_CODE
     */
    public void openAlbumForMultiple(Activity activity, int count, int REQUEST_CODE) {
        openAlbum(activity, false, false, GlideEngine.getInstance(), false, count, REQUEST_CODE);
    }


    private void openAlbum(Activity activity, boolean isShowCamera, boolean useWidth, @NonNull ImageEngine imageEngine, boolean isPuzzle, int count, int REQUEST_CODE) {
